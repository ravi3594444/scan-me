...
object TestTags {
    ...
    const val INCOMING_ACCEPT = "incoming.accept"
    const val INCOMING_DECLINE = "incoming.decline"
    const val BROWSER_ALLOW = "browser.allow"
    const val INSTALLER_WARNING = "installer.warning"
